...
public class IndexerSubsystem extends SubsystemBase {
    ...
    public IndexerSubsystem() {
        ...
        this.motor = new TalonFX(IndexerConstants.INDEXER_MOTOR_CAN_ID);
    ...
    public Command forwardUntilSensor(DigitalInput beamBreak) {
        return Commands.run(() -> indexer.set(DEFAULT_SPEED), this)
                .until(() -> !beamBreak.get())
                .andThen(stop());
    }
